...
ace.define('ace/mode/javascript_worker', ['require', 'exports', 'module', 'ace/lib/oop', 'ace/worker/mirror', 'ace/mode/javascript/jshint'], function(require, exports, module) {
    ...
    (function() {
        ...
        /**
         * NOTE: this always returns false using ace in chrome app as the eval is not allowed         *
         */
        ...
        this.onUpdate = function() {
            ...
            //console.log('lint.errors',lint.errors); //shows all errors in console
        ...
        if (function() { // test IE < 9 to splice bug - see issue #138
            ...
            Array.prototype.splice = function(start, deleteCount) {
                if (!arguments.length) {
                    ...
                    deleteCount === void 0 ? (this.length - start) : deleteCount].concat(slice.call(arguments, 2)))
                }
            };
        }
        else { //IE8
        ...
        3: [function(_dereq_, module, exports) {
            ...
            var JSHINT = (function() {
                ...
                function warning(code, t, a, b, c, d) {
                   ...
                   // console.log(' state.option.maxerr', state.option.maxerr, 'total errors found',JSHINT.errors.length);
                ...
                function expression(rbp, initial) {
                    ...
                    if (state.option.asi && (state.tokens.curr.id === "[" || state.tokens.curr.id === "(" || state.tokens.curr.id === "/") && state.tokens.prev.line < state.tokens.curr.line) warning("W014", state.tokens.curr, state.tokens.curr.id);
                ...
                (function(x) {
                    x.nud = function(isclassdef) {
                        ...
                        function saveProperty(name, tkn) {
                            if (props[name] && _.has(props, name)) warning("W075", state.tokens.next, i);
                            else props[name] = {};
